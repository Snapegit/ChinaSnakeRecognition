...
<template>
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0 18%","margin":"20px auto 60px","color":"#666","background":"#fff","width":"100%","fontSize":"14px","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				<el-col :span="24">
					<el-form-item label="名称" prop="dongwumingcheng">
						<el-input class="list_inp" v-model="form.dongwumingcheng" placeholder="名称"
							 type="text" 							:readonly="!isAdd||disabledForm.dongwumingcheng?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="24">
					<el-form-item label="图片" prop="dongwutupian">
						<uploads
...
<script setup>
	...
	const dongwutupianUploadSuccess=(e)=>{
		...
		if(e){
			context?.$http({
				url: `${tableName}/baidu/animal?fileName=`+e.substr(e.lastIndexOf("/")+1),
				method: 'get'
			}).then(res=>{
				form.value.dongwumingcheng = res.data.data.name;
			})
		}
	}
	//methods
